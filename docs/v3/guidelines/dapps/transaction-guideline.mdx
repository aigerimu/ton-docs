...
Представьте город в котором функционирует городская почта и люди-акторы не покидают своих домов. Для общения люди могут принимать сообщение с запросом на какую-либо работу, делать работу внутри дома, и прикладывать отчет о проделанной работе, отправлять другому жителю.
Каждый человек будет выходить к почтовому ящику забирать ровно одно входящее письмо и затем запираться наглухо дома, пока не выполнят работу о которой их попросили.
